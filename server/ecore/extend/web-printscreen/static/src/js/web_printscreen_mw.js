ecore.define('Web_Printscreen', function (require) {
"use strict";
...
ListView.include({
	...
	export_to_excel: function(export_type) {
            ...
            //Find Data Element
            var data_eles = self.$el.find('.o_list_view .table .table-condensed .table-striped > tbody > tr')
            var export_data = []//
...
//	                        text = instance.web.parse_value(text, { type:"float" })
            ...
            //Find Footer Element
            var footer_eles = self.$el.find('.o_list_view> tbody > tr')
