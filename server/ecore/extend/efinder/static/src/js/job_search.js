ecore.efinder = function (instance) 
{
...
*/
	...
	instance.efinder.JobSearch = instance.web.Widget.extend
	({
	...
	({
	    do_update: function() {
	        ...
	        this.update_promise.done(function()
	        {
	            ...
	            {
		        	self.job_search = new instance.efinder.JobSearch(self);
